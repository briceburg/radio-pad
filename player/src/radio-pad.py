...
async def handle_msg(msg, source):
    ...
    try:
        if event == "volume":
            ...
            print(f"{source}: station request: {data}")
            await play_station(data)
